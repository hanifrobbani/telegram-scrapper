    ...
    return (
        <div className="">
            {[...Array(totalSkeleton)].map((_, index) => (
                <div key={index} className="grid grid-cols-[48px_1fr_2fr_80px] bg-white shadow-md items-start px-3 py-3 border-b border-slate-200 hover:bg-gray-50 transition-colors">
                    <div>
